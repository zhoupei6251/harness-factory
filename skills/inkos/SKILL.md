---
name: inkos
description: Autonomous novel writing CLI agent with web workbench (InkOS Studio)
  - use for creative fiction writing, novel generation, style imitation, chapter continuation/import,
  EPUB export, AIGC detection,...
version: 2.3.3
metadata:
  openclaw:
    emoji: 📖
    ...
    - id: npm
      ...
      label: Install InkOS (npm)
when_to_use: 调用 inkos 时
status: peripheral
tags:
- 创作
- 系统
