...
description: Self-reflection + Self-criticism + Self-learning + Self-organizing memory.
  Agent evaluates its own work, catches mistakes, and improves permanently. Use when
  (1) a command, tool, API, or operation ...
changelog: Clarifies the setup flow for proactive follow-through and safer installation
  behavior.
metadata:
  clawdbot:
    emoji: 🧠
    ...
    - ./SOUL.md
    - ./HEARTBEAT.md
when_to_use: 调用 self-improving 时
status: peripheral
tags:
- self-improve
- learning
domain: code
category: code.ai-agent
---
## When to Use
