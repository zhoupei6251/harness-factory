...
description: Plans and executes safe refactors with small steps, tests, and rollback
  strategy. Use when 重构, 技术债, 安全重构, refactoring, or improving code structure without
  breaking behavior.
version: 1.0.0
when_to_use: 调用 refactor-safely 时
status: peripheral
tags:
- refactor
- safe
