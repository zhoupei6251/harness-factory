...
source:
  ...
  - harness-factory/init/templates/project.profile.md
  - harness-factory/init/templates/context-map.md
  - harness-factory/init/templates/project.verification.md
  - harness-factory/init/templates/project.git.md
...
以 `harness-factory/init/templates/` 中同名文件为**章节骨架**（保留「推断项」「待确认项」等节），创建或更新：

1. `harness-factory/project.profile.md`
2. `harness-factory/init/templates/context-map.md`
